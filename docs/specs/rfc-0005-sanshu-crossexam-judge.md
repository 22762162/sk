...
- 定位回归 DESIGN §2.1 既批准方案:**三家轮换、全新无状态匿名盲评;并非独立第四真值源,
  不保证单场独立性**。裁判由 seed 逐场轮换,输入为三家脱敏封存三段+全部质证记录(匿名 甲乙丙,
  含裁判自家的匿名段);自评偏差经跨场轮换平衡,并在每场 manifest 披露裁判供应商以供复盘分层。
  (若未来要求真正排除自身或引入第四家独立裁判,属新设计,须本人另行批准。)
- 输出契约(要点):per_provider[3]×per_section 的
  {consistency: "consistent|partial|contradicted", note≤200字}、
  cross_method_note(两法相悖面归纳,≤300字)、
  scorable: 每段是否可入复盘分母(弃答/失败标记透传,不改写;unresolved 为合法裁定)、
